      ...
      <SidebarInset>
        <header className="flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
          ...
          <div className="ml-auto px-4 flex items-center gap-4">
            <p className="text-sm text-muted-foreground">Welcome back, {user?.fullName || user?.email}</p>
            <ThemeToggle />
          </div>
        </header>
          ...
          <div className="min-h-[100vh] flex-1 rounded-xl bg-muted/50 md:min-h-min">
            <div className="p-6 space-y-8">
              <div>
                ...
                <p className="text-muted-foreground">View, filter and update order statuses</p>
              </div>
